...
ghdl -a --std=08 ../../Komponenten/Multiplexer/gen_4_to_1_mux.vhdl
ghdl -a --std=08 ../../Komponenten/SignExtender/signExtension.vhdl
ghdl -a --std=08 ../../Komponenten/Memory/data_memory.vhdl

## RISC-V
ghdl -a --std=08 ../../RISC-V/RIUBS_only_RISC_V.vhdl

# compile testbench
ghdl -a --std=08 ../../Testbenches/RISC-V/riubs_only_RISC_V_tb2.vhdl

# create testbench entity
ghdl -e --std=08 riubs_only_RISC_V_tb2

# start simulation and create vcd-file
ghdl -r --std=08 riubs_only_RISC_V_tb2 --wave=riubs_riscv_debug2.ghw

# launch gtkwave
gtkwave riubs_riscv_debug2.ghw
