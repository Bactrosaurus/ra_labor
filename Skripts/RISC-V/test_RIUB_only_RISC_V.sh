...
## RISC-V
ghdl -a --std=08 ../../RISC-V/RIUB_only_RISC_V.vhdl

# compile testbench
ghdl -a --std=08 ../../Testbenches/RISC-V/riub_only_RISC_V_tb.vhdl

# create testbench entity
ghdl -e --std=08 riub_only_RISC_V_tb

# start simulation and create vcd-file
ghdl -r --std=08 riub_only_RISC_V_tb --wave=riub_riscv_debug.ghw

# launch gtkwave
gtkwave riub_riscv_debug.ghw
