...
## RISC-V
ghdl -a --std=08 ../../RISC-V/RIU_only_RISC_V.vhdl

# compile testbench
ghdl -a --std=08 ../../Testbenches/RISC-V/riu_only_RISC_V_tb.vhdl

# create testbench entity
ghdl -e --std=08 riu_only_RISC_V_tb

# start simulation and create vcd-file
ghdl -r --std=08 riu_only_RISC_V_tb --wave=riu_riscv_debug.ghw

# launch gtkwave
gtkwave riu_riscv_debug.ghw
